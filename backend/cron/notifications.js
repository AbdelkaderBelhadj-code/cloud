...
/**
 * Run all four passes once. Exported so it can be triggered manually
 * (scripts / admin endpoint) without waiting for the scheduled tick.
 */
async function runLicenseExpiryCheck() {
    ...
    return {
        ...
        sent30d: list30.length,
        sentDaily: listDaily.length,
    };
}
